...
<head>
    <title> USIM Discussion Forum </title>
...
<body id="_1">
    ...
    <div id="content">
        <div id="searchbox">
            <center>
                <div class="heading">
                    <img src="https://stracomm.usim.edu.my/wp-content/uploads/2018/05/LOGO-1Axl.png" alt="USIM Logo" style="height:300px;"> <!-- Adjust the height as needed -->

                    <h1 class="logo">
                        <div id="ntro">USIM News</div>
                    </h1>
