...
(21, 'What are various phases of SDLC?\r\n', 'The generic phases of SDLC are: Requirement Gathering, System Analysis and Design, Coding, Testing and implementation. The phases depend upon the model we choose to develop software.', 'Brahmendra', 'admin'),
...
(27, 'What are non-functional requirements?\r\n', 'Non-functional requirements are implicit and are related to security, performance, look and feel of user interface, interoperability, cost etc.', 'Himaja_MAM', 'admin'),
(28, 'How many types of Grammars are there in theory of computation?', 'According to chomsky hierarchy, grammars are divided of 4 types:\n<ol style="padding-left: 40px;">\n   <li>Type 0 known as unrestricted grammar.</li>\n   <li>Type 1 known as context sensitive grammar.</li>\n   <li>Type 2 known as context free grammar.</li>\n   <li>Type 3 Regular Grammar.</li>\n</ol>Their Power decreases from type 0 to type 3.', 'Himaja_MAM', 'admin'),
(29, 'How is the developer of Interrogate website?', 'Shivam Rathore', 'Sreenadh', 'admin'),
(30, 'Ask a Question?', 'Why This question', 'Sreenadh', 'admin'),
(32, 'What is ShivamRathore?', 'It is a Object in My Library ;p', 'Pranitha', 'admin'),
(33, 'How is this page working?', 'This page is working on HTML, CSS, JavaScript, PHP, and on MySQL Database.', 'Sreenadh', 'Brahmendra'),
(39, 'Nothing to ask.', NULL, 'Sreenadh', NULL);
...
(17, 'admin', 'admin', 'admin123', 'admin@gmail.com', '2023-04-11 18:59:57'),
(9, 'Susmith kumar', 'susmith123', 'Susmith Kumar', 'Susmith@gmail.com', '2023-03-30 16:34:59'),
(13, 'Pranitha', 'pranitha123', 'Pranitha', 'Pranitha@gmail.com', '2023-03-30 17:09:07'),
(8, 'Sreenadh', 'sreenadh123', 'Sreenadh Bhargav', 'Sreenadh@gmail.com', '2023-03-30 13:26:51'),
(11, 'susmith2', 'susmith456', 'Susmith k', 'susmith2@gmail.com', '2023-03-30 16:43:21'),
(14, 'Nalinee', 'nalinee123', 'Nalinee Priya', 'NalineeP@gmail.com', '2023-04-02 11:31:17'),
(16, 'Himaja_MAM', 'himaja123', 'Himaja_MAM', 'Himaja@gmail.com', '2023-04-07 06:05:51'),
(15, 'Brahmendra', 'brahmendra123', 'Brahmendra Ramoju', 'brahmendra@gmail.com', '2023-04-06 13:30:39');
